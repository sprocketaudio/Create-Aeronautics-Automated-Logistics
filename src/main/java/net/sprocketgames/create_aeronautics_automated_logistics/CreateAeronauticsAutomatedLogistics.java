...
import net.sprocketgames.create_aeronautics_automated_logistics.registry.ModSimulatedSections;
...
public class CreateAeronauticsAutomatedLogistics {
    ...
    public CreateAeronauticsAutomatedLogistics(IEventBus modEventBus, ModContainer modContainer) {
        ...
        ModSimulatedSections.bootstrap();
        ModMenus.MENUS.register(modEventBus);
        ModBlockEntities.BLOCK_ENTITY_TYPES.register(modEventBus);
        AutomatedLogisticsConfig.migrateLegacyOwnershipPermissions(FMLPaths.CONFIGDIR.get().resolve(MOD_ID + "-common.toml"));
